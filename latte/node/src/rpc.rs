...
//! kobole provides the `sc-rpc` crate, which defines the core RPC layer
//! used by kobole nodes. This file extends those RPC definitions with
...
use ratara_runtime::{opaque::Block};
